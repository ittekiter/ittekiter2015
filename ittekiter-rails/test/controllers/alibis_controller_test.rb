...
class AlibisControllerTest < ActionController::TestCase
  ...
  test "should create alibi" do
    assert_difference('Alibi.count') do
      post :create, alibi: { dep: @alibi.dep, dep_time: @alibi.dep_time, des: @alibi.des, route_object: @alibi.route_object, user_id: @alibi.user_id }
    end
  ...
  test "should update alibi" do
    patch :update, id: @alibi, alibi: { dep: @alibi.dep, dep_time: @alibi.dep_time, des: @alibi.des, route_object: @alibi.route_object, user_id: @alibi.user_id }
    assert_redirected_to alibi_path(assigns(:alibi))
  end
